...
const CreateUserBet = ({ navigation }) => {
    ...
    events: [
      {
        gamesEvent: [
          ...
          },
          {
            ...
            startAwayTeam: 0,
            bet: [0, 0, 0],
            _id: "6140726605c0e0001639c67",
            homeTeam: "Angers",
            awayTeam: "Nntes",
            gameApi: "688a3d5e236b205314f4",
            startGame: "2021-09-19T13:00:00.000Z",
            __v: 0,
          },
          // {
          ...
          //   startAwayTeam: 0,
          //   bet: [0, 0, 0],
          //   _id: "61407265c0e0001639c67",
          //   homeTeam: "Angers",
          //   awayTeam: "Nantes",
          //   gameApi: "61388d5e2ec36b205314f4",
          //   startGame: "2021-09-19T13:00:00.000Z",
          //   __v: 0,
          // },
        ],
  ...
  const postUserBet = () => {
    ...
    //     { mask, doubles: totoGamos.doubles, triangles, eventId: "61419b9f63689e00168d30fb", gameEvents: mygames },
    //     {
    //       headers: {
  ...
  const userBets = totoGamos.events[0].gamesEvent;

  const gamesEventss = [];
  const choosenBet = (indexGame, indexBet) => {
    // console.log("Before ",userBets[indexGame].bet[indexBet]);

    userBets[indexGame].bet[indexBet] === 1
      ? (userBets[indexGame].bet[indexBet] = 0)
      : (userBets[indexGame].bet[indexBet] = 1);
      setMyGames(userBets)
      // console.log("after ",userBets[indexGame].bet[indexBet]);
