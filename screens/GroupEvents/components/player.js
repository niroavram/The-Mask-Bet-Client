...
const Players = (props) => {
  ...
  return (
            <View style={{ width: wid * 0.98}}>    
                  <View   style={{flexDirection:"row", borderRadius: SIZES.radius-10,backgroundColor: isWinner? COLORS.darkWhite : COLORS.orangePrimary, justifyContent:'center', flexWrap:'wrap', marginBottom:20}}>
